...
The goal of Chat is to screen abstracts and titles using OpenAI's GPT API models.
...
The `chat` function is used to make queries to OpenAI's API models. The function takes four arguments:
...
The function returns a dataframe containing the study title, study ID, and the response from OpenAI's API models.
